/*
------------------------------------------------
Generated by Cradle 2.0.0.0 on 10/27/2016 14:14:08
...
public partial class @HarloweTests: Cradle.StoryFormats.Harlowe.HarloweStory
{
	...
	IStoryThread passage16_Main()
	{
		...
		using (Group("hook", "9fdf58"))
			yield return link("Link macro", null, () => enchantHook("9fdf58", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	IStoryThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "cd9355"))
			yield return link("Click and it's gone", null, () => enchantHook("cd9355", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "732483"))
			yield return link("Click and it's gone", null, () => enchantHook("732483", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "b053fe"))
			yield return link("What comes next?", null, () => enchantHook("b053fe", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("0ce9e6", HarloweEnchantCommand.Replace, passage17_Fragment_3));
		using (Group("hook", "0ce9e6")) {}
		yield break;
	}
