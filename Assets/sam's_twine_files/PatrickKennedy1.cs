...
public partial class @PatrickKennedy1: Cradle.StoryFormats.Harlowe.HarloweStory
{
	#region Variables
	// ---------------
	...
	IStoryThread passage4_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		yield return link("Go into the workhouse((MainEntrance))", "Go into the workhouse", null);
		yield return text(" ");
		yield return lineBreak();
		yield break;
	}
